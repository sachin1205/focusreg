...
<!--Site Footer -->
<!-- <footer class="site-footer" role="contentinfo">&copy; <?php echo date("Y"); ?> <?php bloginfo( 'name' ); ?>. All rights reserved.</footer> -->

<footer class="site-footer" role="contentinfo">
  <div class="inner-wrap-fullwidth">
    <p class="footer-links">&copy; <?php echo date("Y"); ?> <?php bloginfo( 'name' ); ?> &nbsp; / &nbsp; <a href="/about/">About</a> &nbsp; / &nbsp; <a href="/resources/">Resources</a> &nbsp; / &nbsp; <a href="/blog">Blog</a> &nbsp; / &nbsp; <a href="/contact/">Contact</a> &nbsp; / &nbsp; <a href="#">Privacy Policy</a> &nbsp; / &nbsp; <a href="/sitemap">Sitemap</a>  </p>
